...
def binary(a, e, m1, m2, mu):
    ...
    dv1dt = acceleration of star 1 (m/s^2)
    dv2dt = acceleration of star 2 (m/s^2)
    accel = relative acceleration between the two stars (m/s^2)
    l1 = angular momentum of star 1 (kg*m^2/s)
    l2 = angular momentum of star 2 (kg*m^2/s)
    L = total angular momentum of the system (kg*m^2/s)
    ...
    v1 = np.sqrt(G*(m1+m2)*((2/r1)-(1/a1))) # angular velocity of star1 (vis-via)
    v2 = np.sqrt(G*(m1+m2)*((2/r2)-(1/a2))) # angular velocity of star2 (vis-via)
    ...
    l1 = m1*r1*v1 # angular momentum of star1
    l2 = m2*r2*v2 # angular momentum of star2
    L = l1 + l2 # total angular momentum of the system (should be relatively constant in this simulation)
    w1 = v1/r1 # angular velocity of star1
    w2 = v2/r2 # angular velocity of star2
    
    return x1, y1, x2, y2, T, t, r, r1, r2, v1, v2, KE1, KE2, KE, U, ME, dv1dt, dv2dt, accel, l1, l2, L, w1, w2

def run(a,e, m1, m2, mu):
    """
    Runs binary star simulation
    """
    x1, y1, x2, y2, T, t, r, r1, r2, v1, v2, KE1, KE2, KE, U, ME, dv1dt, dv2dt, accel, l1, l2, L, w1, w2 = binary(a,e,m1,m2,mu)
...
data = {
    ...
    'Angular Momentum of Star 1 (kg*m^2/s)': l1,
    'Angular Momentum of Star 2 (kg*m^2/s)': l2,
    'Total Angular Momentum (kg*m^2/s)': L,
